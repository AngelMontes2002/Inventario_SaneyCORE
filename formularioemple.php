   ...
   <div class="blue_bg">
      <div class="container">
         <div class="row">
            <div class="col-md-12">
               <div class="titlepage">
                  <h2><img src="images/heading_iconw.png" alt="#" />Registro</h2>
               </div>
            </div>
         </div>
      </div>
   ...
   <div id="contact" class="contact">
      <div class="con_bg">
         <div class="container-fluid">
            <div class="row ">
               <div class="col-md-6">
                  <form id="request" action="trasaccion/trasaction.php" class="main_form" method="POST">
                     <div class="row">
                        <div class="col-md-12 ">
                           <input class="contactus" placeholder="Nombre Completo" type="type" name="nombre" required>
                        </div>
                        <div class="col-md-12">
                        <p>
                           Tipo de Documento:
                        ...
                        <div class="col-md-12">
                           <input class="contactus" placeholder="Numero de Identidad" type="number" name="documento" required>
                        </div>
                        <div class="col-md-12">
                           <input class="contactus" placeholder="Fecha Nacimiento" type="date" name="fecha_na" required>
                        </div>
                        <div class="col-md-12">
                           <input class="contactus" placeholder="Direccion" type="text" name="direccion" required>
                        </div>
                        <div class="col-md-12">
                           <button class="send_btn">Enviar</button>
                           <button class="send_btn" type="reset">Borrar</button>
                        </div>
                     </div>
                  </form>
               </div>
                  ...
                  <div class="fid_box">
                     ...
                     <ul class="location_icon">
                        ...
                        <li><a href="Javascript:void(0)"><i class="fa fa-phone" aria-hidden="true"></i></a><br>
                           (+57) 1234567890<br> (+57) 1234567890
                        </li>
